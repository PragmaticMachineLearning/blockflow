...
grandparent_block = Block(name="grandparent", text="this is a grandparent statement", max_tokens=5)
parent_block = Block(name="parent", text= "this  is a parent statement")
child_a = TextBlock(
    name="child a",
...
max_tokens=100)
child_b = TextBlock(name="child b", text="This is another block", max_tokens=2, truncate="left")
