...
# TODO: use llmagic to handle prompt lengths for each result obtained from the search_topic function, so each result has the same number of tokens in the prompt
